...
surface_set_target(waterSurface)
    ...
    _left,
    _top,
    sprite_width, sprite_height+transparencyBufferHeight,
    0, 0,
    1, 1,
    c_white, 1
);
	...
	draw_line(0,transparencyBufferHeight+1,sprite_width,transparencyBufferHeight)
